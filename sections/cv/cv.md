...
- 2022-today Senior AI Researcher at Ipazia SpA, Milan, Italy.
  Research and engineering on modern AI systems, with a focus on translating mathematically grounded ideas into reliable methods, reusable software, and collaborative research directions.
- 2020-2022 Senior analyst/data scientist at Prometeia, Milan, Italy. Data science, distributed computing (Spark), anti-money laundering.
  Worked in large cross-functional teams on high-impact finance projects, aligning technical work with stakeholder needs and operational constraints.
...
Worked in large collaborative teams, shoulder to shoulder with stakeholders over a number of finance-related projects from NPL prediction to anti-money laundering methods rooted in rigorous data science algorithms.
Contributed at the intersection of modeling, data engineering, and delivery, helping translate complex analytical work into solutions usable by business and risk teams.
...
This work combined methodological research, scientific software development, and day-to-day collaboration with experimental researchers.
...
Responsible for keeping shared computational infrastructure reliable and available for research work.
...
Delivered an end-to-end technical system in an international research setting, from implementation to testing and installation.
...
Acted as a technical reference point for shared experimental software, helping keep research code robust, maintainable, and useful across projects and collaborators.
...
This was my first sustained experience working on machine learning systems with both theoretical and applied constraints in mind.
