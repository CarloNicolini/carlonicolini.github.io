...
## 🚀 Supercharge Your Terminal: Claude Code CLI with OpenRouter
...
### ⚙️ Step 2: Install Claude Code CLI
...
### 🌍 Step 3: Configure Claude Code for OpenRouter (The Magic!)
...
# --- Model Aliasing for Claude Code v2.1.x+ ---
# This "tricks" Claude Code into using your desired OpenRouter model
# even for its internal sub-agents and tool calls.
# We'll target NVIDIA Nemotron-3-4-12B-Instruct, which often has a free tier.
# (Note: Nemotron-3-Super-120B-A12B is typically paid/rate-limited on OpenRouter;
# the more common free one is Nemotron-3-4-12B-Instruct or similar 8B variants.)
export ANTHROPIC_DEFAULT_SONNET_MODEL="nvidia/nemotron-3-4-12b-instruct"
export ANTHROPIC_DEFAULT_HAIKU_MODEL="nvidia/nemotron-3-4-12b-instruct"
export ANTHROPIC_DEFAULT_OPUS_MODEL="nvidia/nemotron-3-4-12b-instruct"

# You can also set a default if you prefer another model for general use
# export ANTHROPIC_DEFAULT_MODEL="google/gemini-2.0-flash-001"