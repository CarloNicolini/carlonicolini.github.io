...
[https://www.youtube.com/watch?v=ILXe_NsvQ6Q&index=5&list=PL17567A1A3F5DB5E4](https://www.youtube.com/watch?v=ILXe_NsvQ6Q&index=5&list=PL17567A1A3F5DB5E4)
...
We take $\Omega = \mathbb{R}$ and $A = \mathbb{B}(\mathbb{R})$. The measure on the open interval $(a,b)$ is defined as
$\mu((a,b)) = b-a$ for any $a,b\in \mathbb{R}$ with $a<b$. This measure is called the *length*. Again this uniquely defines a measure on all the sets.
...
2. *Subadditivity*: If we have some sequence  $E_1, E_2,\ldots \in A$, then $\mu\left( \limits_{i=1}^\infty \bigcup E_i \right) \leq \sum_{i=1}^{\infty} \mu(E_i$) $
This happens because you could double count some sets.
...
$\mu \left( \limits_{i=1}^\infty \bigcup E_i \right)  = \lim_{i\to \infty} \mu(E_i)$
4. *Continuity from above*: If $E_1,E_2 \in A$ and $E_1 \superset E_2 ,\ldots \superset $, and further, the measure of $E_1$ is finite, then 
$\mu \left( \limits_{i=1}^\infty \bigcap E_i \right)  = \lim_{i\to \infty} \mu(E_i)$
...
[https://www.youtube.com/watch?v=t4cwYCVyQLM&list=PL17567A1A3F5DB5E4&index=7](https://www.youtube.com/watch?v=t4cwYCVyQLM&list=PL17567A1A3F5DB5E4&index=7)
...
3. $P(E) = 1-P(F)$
4. *Inclusion exclusion formula* $$P\left (\bigcup_{i=1}^n E_i \right) = \sum_i P(E_i) - \sum_{i<j} P(E_i \cap E_j) + \sum_{i<j<k} P(E_i \cap E_j \cap E_k) - \ldots ... + (-1)^{n+1} P(E_1 \cap E_2 \cap \ldots \cap E_n)$$
...
[https://www.youtube.com/watch?v=aJjB16jJQEQ&list=PL17567A1A3F5DB5E4&index=9](https://www.youtube.com/watch?v=aJjB16jJQEQ&list=PL17567A1A3F5DB5E4&index=9)
Some references:
