...
I am particularly interested in LLM systems, [vector symbolic architectures](https://openreview.net/forum?id=MSm0VFL9pq), mechanistic interpretability, AI reliability, probabilistic language programming, and the design of scaffolds that make inference-time behavior more auditable and semantically grounded.
...
I maintain a small blog to document my ideas, my research progress and a live scratchpad of my daily research work.
...
You can ask me for connection on LinkedIn and send me DM.
I no longer have any social media account apart from that.

Find my contact on [LinkedIn](https://www.linkedin.com/in/carlo-nicolini).
